...
import org.petstar.controller.ETAD.ReportesController;
 ...
 * @author Tech-Pro
 */
@WebServlet(name = "EtadReportes", urlPatterns = {"/EtadReportes"})
public class EtadReportes extends HttpServlet {
        ...
        try {
            ...
            switch (action) {
                case "loadCombobox":
                    ...
                    break;
                case "getIndicadorClaveDesempenoByGrupo":
                   output = controller.getIndicadorClaveDesempenoByGrupo(request);
                   break;
                ...
                case "getReporteBonos":
                   output = controller.getReporteBonos(request, false);
                   break;
