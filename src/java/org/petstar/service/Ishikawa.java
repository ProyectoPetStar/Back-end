...
import org.petstar.controller.ishikawa.IshikawaController;
 ...
 * @author Tech-Pro
 */
@WebServlet(name = "Ishikawa", urlPatterns = {"/Ishikawa"})
public class Ishikawa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        IshikawaController controller = new IshikawaController();
        Gson gson = new Gson();
